...
public class Main {
    ...
    public static void generateEmployees() { // создание сотрудников
        employees[0] = new Employee("Иванов Максим Филипович", 1, 20_437);
        employees[1] = new Employee("Смирнов Андрей Юрьевич", 2, 19_000);
        employees[2] = new Employee("Кузнецов Александр Владимирович", 3, 10_568);
        employees[3] = new Employee("Попова Алиса Геннадьевна", 1, 12_000);
        employees[4] = new Employee("Васильев Игорь Андреевич", 2, 40_341);
        employees[5] = new Employee("Петров Максим Александрович", 4, 21_237);
        employees[6] = new Employee("Соколова Александра Васильевна", 5, 27_445);
        employees[7] = new Employee("Михайлова Полина Алексеевна", 3, 23_400);
        employees[8] = new Employee("Григорьян Сергей Артемович", 5, 30_000);
        employees[9] = new Employee("Осеченко Иван Иванович", 4, 20_000);
    }
